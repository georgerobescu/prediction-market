...
// default to 20 minutes later
const defaultResolutionTime = Math.floor(Date.now() / 1000) + 45 * 60;
...
module.exports = {
  // Minted Assets Oracle Configs
  sumMintedResolutionTime:
    process.env.SUMMINTEDRESOLUTIONTIME || defaultResolutionTime,
  sumMintedTargetValue: process.env.SUMMINTEDTARGETVALUE || "1000",
  sumMintedQuestionID: process.env.SUMMINTEDQUESTIONID || "0x01",
